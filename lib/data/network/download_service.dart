...
class DownloadService {
  ...
  Future<String?> downloadTrack(String url, String filename, {String? albumArtUrl, Function(double)? onProgress}) async {
    ...
    try {
      ...
      final songDirectory = Directory('${baseDirectory.path}/LuxTune/$safeName');
